...
if (startIdx !== -1) {
  ...
  // Extract just the string content, excluding leading/trailing whitespace
  ...
  if (firstQuote !== -1 && lastQuote !== -1) {
    ...
    // Replace all physical newlines inside the JSON string literal with \n
    // Or just remove them. But since they are breaking the HTML code (e.g. at spaces),
  ...
  console.log('Fixed JSON error in __bundler/template.');
} else {
